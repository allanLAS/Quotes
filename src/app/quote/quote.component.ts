...
export class QuoteComponent implements OnInit {
  ...
  quotes:Quote[]=  [
    ...
    new Quote(3,'Regardless of how it goes down, life goes on','Rick Ross',new Date(2019,1,11)),
    new Quote(4,'We make a living by what we get, but we make a life by what we give.','Sir Winston Churchill',new Date(2019,5,19)),
    new Quote(5,'Study hard so that you can master technology, which allows us to master nature.','Che Guevara',new Date(2018,4,20)),
